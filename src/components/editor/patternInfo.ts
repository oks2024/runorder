/**
 * One source of truth for the pattern vocabulary shown to the user: badge labels and
 * tooltip copy. Used by the CompositionPane add-buttons and the PhaseRow badges so both
 * surfaces describe a pattern identically. Copy states what the *emitted script does* —
 * including the injected plumbing (reads splice, forced schemas) — not aspirations.
 */
