...
/**
 * The seven topology glyphs shown on the pattern shelf (mockup `.pat svg`, lines 273-286),
 * ported verbatim: same viewBox, same paths, `currentColor` fill/stroke so they inherit the
 * card's `text-ink-dim`. Kept as one map so `PatternCard`/`Shelf` can look a glyph up by kind.
 */
